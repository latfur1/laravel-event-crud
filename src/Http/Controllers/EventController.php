...
class EventController extends Controller
{
    ...
    public function all_event(){
        ...
        foreach ($all_event as $key => $event_val) {
            ...
            $event_data[$key]['start'] = $event_val['event_start_date'] . ' ' . 
                date('H:i:s', strtotime($event_val['event_start_time']));

            $event_data[$key]['end'] = $event_val['event_end_date'] . ' ' . 
                date('H:i:s', strtotime($event_val['event_end_time']));
            ...
            $event_data[$key]['end_formate']  =implode("/", array_reverse(explode("-", $event_val['event_end_date']))) . ' ' . 
                date('h:i:s A', strtotime($event_val['event_end_time']));
